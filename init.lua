...
require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'bash', 'fish', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim' },
...
local on_attach = function(_, bufnr)
    ...
    nmap('H', '^', 'Scroll to most left')
    nmap('L', '$', 'Scroll to most right')

    nmap('<leader>w', ':w<cr>', 'save the file')
